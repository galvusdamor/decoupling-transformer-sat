...
This repository contains the code for the JELIA 205 paper ([[pdf]](https://ai.dmi.unibas.ch/papers/behnke-et-al-jelia2025.pdf) [[bib]](https://mrlab.ai/papers/behnke-et-al-jelia2025.html)). 
It extends [Fast Downward 23.06](https://github.com/aibasel/downward/) by planning as satisfiablity that supports conditional effects and axioms.

The Kissat SAT solver is needed for running the SAT-based configurations. We used and tested Kissat in revision da2b0641996913cbc18c2e08cc3945367c395143, which is not part of this repository and can be downloaded here: https://github.com/arminbiere/kissat .
...
## Citation
Gregor Behnke and David Speck and Daniel Gnad:
AxSAT - Bringing Axioms to SAT Planning.
JELIA 2025: 77-93.
[[pdf]](https://mrlab.ai/papers/behnke-et-al-jelia2025.pdf) [[bib]](https://mrlab.ai/papers/behnke-et-al-jelia2025.html)
