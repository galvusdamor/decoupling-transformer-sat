...
exp.add_fetcher("data/2024-08-29-30min-eval/", name='fetch-base', merge=True)
...
exp.add_report(AbsoluteReport(attributes=attributes, filter=[factoring_filter.add_runs, factoring_filter.filter_non_decoupled_runs, filter_kissat_oom, virtual_solver_filter.add_run, virtual_solver_filter.replace_config],
...
factoring_filter.print_statistics()
