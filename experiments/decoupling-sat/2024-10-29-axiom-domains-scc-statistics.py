...
searches = {"Esat": ["--translate-options", "--skip-negative-axioms", "--search-options", "--root-task-transform", "sat_axiom()", "--search", "sat(encoding=2, plan_length=1)"],
}
...
attributes = ['number_statically_true_dvars', 'percentage_statically_true_dvars', "number_disabling_graph_sccs", "number_sccs"]
