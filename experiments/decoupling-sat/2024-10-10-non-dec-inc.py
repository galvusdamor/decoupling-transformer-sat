...
REVISION = "1597a3dcaf40a1b70c06fb9d581b7253b85f2dd9"
REVISIONS = [REVISION]
...
virtual_solver_filter = filters.VirtualSat(["sat17-LP-F0.2s1M-clo", "sat17-LP-L0.8s1M-clo", "Esat17-LP-F0.2s1M-clo", "Esat17-LP-L0.8s1M-clo"], 1800, ["sat", "Esat"])

factoring_filter_mob = filters.NonDecoupledTaskFilter(["sat17-LP-F0.2s1M-clo", "Esat17-LP-F0.2s1M-clo"])

exp.add_report(AbsoluteReport(attributes=attributes, filter=[filters.remove_revision, factoring_filter_mob.add_runs, factoring_filter_mob.filter_non_decoupled_runs, filter_kissat_oom, virtual_solver_filter.add_run, virtual_solver_filter.replace_config],
                              filter_algorithm=["blind", "blind-LP-F0.2s1M", 
                                                "sat", "sat-LP-F0.2s1M-clo", 
                                                "Esat", "Esat-LP-F0.2s1M-clo",
                                                "sat-inc", "sat-inc-LP-F0.2s1M-clo", "sat-inc-LP-L0.8s1M-clo",
                                                "Esat-inc", "Esat-inc-LP-F0.2s1M-clo", "Esat-inc-LP-L0.8s1M-clo",
                                                "ff", "ff-LP-F0.2s1M"]), outfile=f"{SCRIPT_NAME}-all-mobility.html")

factoring_filter_leaf = filters.NonDecoupledTaskFilter(["sat17-LP-L0.8s1M-clo", "Esat17-LP-L0.8s1M-clo"])

exp.add_report(AbsoluteReport(attributes=attributes, filter=[filters.remove_revision, factoring_filter_leaf.add_runs, factoring_filter_leaf.filter_non_decoupled_runs, filter_kissat_oom, virtual_solver_filter.add_run, virtual_solver_filter.replace_config],
                              filter_algorithm=["blind", "blind-LP-F0.2s1M", 
                                                "sat", "sat-LP-F0.2s1M-clo", 
                                                "Esat", "Esat-LP-F0.2s1M-clo",
                                                "sat-inc", "sat-inc-LP-F0.2s1M-clo", "sat-inc-LP-L0.8s1M-clo",
                                                "Esat-inc", "Esat-inc-LP-F0.2s1M-clo", "Esat-inc-LP-L0.8s1M-clo",
                                                "ff", "ff-LP-F0.2s1M"]), outfile=f"{SCRIPT_NAME}-all-leaves.html")
